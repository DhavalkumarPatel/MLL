		...
		try
		{
			...
			if(null != invite)
			{
				...
				if(null != invite.getToken().getId())
				{
					...
					invite.setUrl("http://ec2-52-37-104-21.us-west-2.compute.amazonaws.com:8080/MLL/index.html#/"+ invite.getToken().getInviteType() + "-registration/token/" + invite.getToken());
				}
				else
				{
